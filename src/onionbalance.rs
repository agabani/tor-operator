 ...
 */
pub struct Config {
    pub onionbalance_image: ImageConfig,
 ...
 * ============================================================================
 */
const APP_KUBERNETES_IO_COMPONENT: &str = "onionbalance";
                ...
                spec: Some(PodSpec {
                    containers: vec![
                        Container {
                            ...
                            image: Some(config.onionbalance_image.uri.clone()),
                            image_pull_policy: Some(config.onionbalance_image.pull_policy.clone()),
